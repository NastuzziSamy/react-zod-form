...
Based on your component mapping, <code>react-zod-form</code> knows which field should receive which props:
...
`react-zod-form` is also aware of which props are required, so it will make sure you always pass required props to your components:
